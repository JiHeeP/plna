...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("Quarterly goals GET error:", e);
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { text, pillar, quarter } = body;
    ...
    console.error("Quarterly goals POST error:", e);
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    console.error("Quarterly goals PATCH error:", e);
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    console.error("Quarterly goals DELETE error:", e);
